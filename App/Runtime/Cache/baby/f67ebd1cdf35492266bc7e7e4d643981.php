...
<script type="text/javascript">
		function change_code(obj){
			var URL = "<?php echo U('Baby/Login/Verify','','');?>";
...
<div class="loginBox">
	<div class="login_cont">
		...
		<form action="<?php echo U("Baby/Login/Login");?>" method="post">
			...
			<li class="mb_10"><input type="code" class="login_input2 user_icon" name="code"/></li><img src="<?php echo U('Baby/Login/Verify');?>" id="code" class="login_input2 user_icon" /> <a href="javascript:void(change_code(this));">看不清</a>
