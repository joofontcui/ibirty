        ...
        <div class="top-info">
            ...
            <div class="top-right">
                <div data-toggle="arrowdown" id="arrow3" class="user-name">
                    <a href="<?php echo U('Baby/Commodity/index');?>">我的北鼻</a>
                    <span class="down-icon"></span>
                </div>
                ...
                <div class="user-info">
                    <div class="gold-top">
                        ...
                        <div class="inner-user">
                            <h3>Hi 北鼻2016</h3>
                            <a class="get-gold" href="<?php echo U('Baby/Commodity/index');?>"><span class="glods"></span><span class="get-money">领淘金币抵钱</span></a>
                            <a class="vip-home" href="<?php echo U('Baby/Commodity/index');?>">会员俱乐部</a>
                        </div>
                    </div>
                    <!--login-->
                    <div class="login">
                        ...
                        <a class="login-btn free" href="<?php echo U('Baby/Register/index');?>">免费开店</a>
                    </div>
                </div>
                <!--service-->
