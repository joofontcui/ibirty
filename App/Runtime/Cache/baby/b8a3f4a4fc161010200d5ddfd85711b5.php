...
<body>
    ...
    <!--main-->
    <div class="cuijun"><hr/>
        <div class="cj-left"><img src="__BABY__/img/6.7.jpg" width="300px"></div>
        <div class="cj-right">
        <form action="" method="post">
            <table claa="cj-table">
            <tr><td width="100px" height="30px">狗狗品种：</td><td><?php echo ($res['foodname']); ?></td></tr>
            <tr><td height="30px">宠物描述：</td><td><?php echo ($res['foodtext']); ?></td></tr>
            ...
            <tr><td height="30px">北鼻卖价：</td><td><?php echo ($res['foodmoney']); ?></td></tr>
            <tr><td height="30px">宠物编号：</td><td><?php echo ($res['foodno']); ?></td></tr>
            <tr><td height="30px">咨询电话：</td><td>15197187787</td></tr>
            <tr><td height="30px"></td><td></td></tr>
            </table>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <span class="font_bk"><a href="<?php echo U('Baby/Shopcar/index');?>">&nbsp;&nbsp;&nbsp;&nbsp;立即购买&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
        </form>
        </div>
    </div>
