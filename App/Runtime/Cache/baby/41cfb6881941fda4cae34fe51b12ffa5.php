	...
	<table id="cartTable">
		...
		<form action="<?php echo U('Baby/Contact/Index');?>" method="post">
			<tr>
				...
				<td class="goods"><img src="__BABY__/foods/<?php echo ($row['foodno']); ?>.jpg" alt=""/><span><?php echo ($row['foodname']); ?></span></td>
				<td class="price" ><?php echo ($row['foodmoney']); ?></td>
				<td class="count"><span class="reduce"></span><input class="count-input" type="text" value="1" name="price1"/><span class="add">+</span></td>
				<td class="subtotal"><?php echo ($row['foodmoney']); ?></td>
