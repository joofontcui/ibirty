...
<table width="1398" height="100" border="0" align="center">
  <tr>
    <th width="1392" height="91" bgcolor="#FF3300" scope="col"><a href="index.html"><img src="__BABY__/img/145705307292200 (2).png" width="250" height="100"></a> <span class="STYLE1">欢迎您登录</span></th>
  </tr>
</table>
<div class="loginBox">
	<div class="login_cont">
		...
		<form action="login.class.php" method="post">
			...
			<li class="mb_10"><input type="text" class="login_input user_icon" name="password" id="pwd1" /></li>
			<li class="autoLogin"><input type="checkbox" id="a1" class="checked"><label for="a1">自动登陆</label></li>
			<li>
			  <table width="400" border="0" align="center">
			    <tr>
			      <td width="270">
			        <input  type="submit" value=""  style="background:url(icon/key02.png) no-repeat; width:140px; height:50px;"/>&nbsp;&nbsp;<a href="shop_register.html"><input type="button" value=""  style="background-image: url(icon/key01.png); width:140px;height:50px;"></input></a>
			      </td>
		        </tr>
		      </table>
			</li>
