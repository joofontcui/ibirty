...
<head>
	<meta charset="UTF-8">
	<title>活动需求</title>
	<link rel="stylesheet" type="text/css" href="__PUBLIC__/css/table.min.css">
...
<body>
	...
	<div class="nav-top">
		...
		<div class="navigation">
			<div class="nav-left">
				...
				<a href="/index.php#service"><span class="nav-left-two">服务项目</span></a>
				<a href="/index.php?s=/Index/Case/index.html"><span class="nav-left-two">加入立创</span></a>
				<a href="/index.php#table"><span class="nav-left-two">活动需求</span></a>
			</div>
			<div class="nav-right">
	...
	<div class="column-in-title">
		<span class="column-in-one">活动预约</span>
		<span class="column-in-one color-blue">活动下单</span>
	</div>


	<!--delivery begin-->
	<div class="delivery">
		<input class="delivery-text-one" type="text" placeholder="姓名">
		<input class="delivery-text-one" type="text" placeholder="电话">
		<input class="delivery-text-one" type="text" placeholder="邮箱">
		<input class="delivery-text-one" type="text" placeholder="公司">
		<input class="delivery-text-one" type="text" placeholder="开始时间">
		<input class="delivery-text-one" type="text" placeholder="结束时间">
		<input class="delivery-text-one" type="text" placeholder="城市">
		<input class="delivery-text-one" type="text" placeholder="活动类型">
		<input class="delivery-text-one" type="text" placeholder="活动人数">
		<input class="delivery-text-one" type="text" placeholder="活动预算">
		<input class="delivery-text-two" type="text" placeholder="活动需求&备注">
		<input class="delivery-text-three" type="submit" value="提交">
	</div>
	<!--delivery end-->
	...
	<div class="tel">
		...
		<a href="tel:17600048677"><span class="tel-cir bac-img-two"> </span></a>
